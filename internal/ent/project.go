...
func (e ProjectEdges) ProjectSongsOrErr() ([]*ProjectSong, error) {
	if e.loadedTypes[0] {
...
// QueryProjectSongs queries the "project_songs" edge of the Project entity.
func (pr *Project) QueryProjectSongs() *ProjectSongQuery {
	return NewProjectClient(pr.config).QueryProjectSongs(pr)
}
